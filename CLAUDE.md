...
| `server/zeek_collector.py` | Zeek log tail (18 log tipi: conn/dns/http/ssl/ssh/notice/smtp/ftp/rdp/kerberos/smb/dce_rpc/weird/dpd/files/dhcp/tunnel/pe) + inotify (B2) |
