...
| `server/zeek_collector.py` | Zeek log tail (17 log tipi: conn/dns/http/ssl/ssh/notice/smtp/ftp/rdp/kerberos/smb/dce_rpc/weird/dpd/files/dhcp/tunnel) + inotify (B2) |
