          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-zinc-800 text-slate-500 text-xs">
                ...
                <th className="ui-th">Event Tipi</th>
                <th className="ui-th">Group By</th>
                <th className="ui-th text-right">Eşik</th>
                <th className="ui-th text-right">Pencere</th>
            ...
            <tbody>
              {rules.map(rule => (
                ...
                >
                  ...
                  <td className="ui-td font-mono text-slate-400 text-xs">
                  ...
                  <td className="ui-td text-right text-zinc-300">{rule.threshold}</td>
                  <td className="ui-td text-right text-slate-400 text-xs">
